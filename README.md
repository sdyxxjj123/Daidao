...
- 2.提前预装国服20S补偿机制
#### 自魔改perfect分支  
需要pip install imgkit和html-table（为什么用这个方法做图片呢，因为网页表格高度自适应且高度自定义）,并安装wkhtmltopdf,安装完要把安装路径/bin加进环境变量)  
...
- 目前来看功能已经够我用了，所以如果没bug也不会更新了（大概
...
[@sdyxxjj123](https://github.com/sdyxxjj123) 项目fork自他的代码，pr好久没消息只好加上感谢了，如果pr合并可自由删减我说的一大堆屁话
感谢各位群友，感谢各位使用者！  
